...
def first(items: list[T]) -> T:  # noqa: UP047 — classic TypeVar syntax, see LESSON.md
    """Return the first item of `items`. Assumes `items` is non-empty.
...
def last_or(items: list[T], default: T) -> T:  # noqa: UP047 — classic TypeVar syntax
